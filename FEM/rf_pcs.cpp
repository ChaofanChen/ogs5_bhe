        ...
        for (std::size_t i = 0; i < vec_BHEs.size(); i++)
        {
            ...
            switch (vec_BHEs[i]->get_type())
            {
                case BHE::BHE_TYPE_1U: // 1U type has 4 unknowns
                    tmp_name_str = std::string(pcs_primary_function_name[1]);
                    tmp_name_str.append("_"); 
                    tmp_name_str.append(vec_BHEs[i]->get_name());
                    nod_val_name_vector.push_back(tmp_name_str.c_str());
                    nod_val_name_vector.push_back(tmp_name_str.c_str());
                    tmp_name_str = std::string(pcs_primary_function_name[3]);
                    tmp_name_str.append("_");
                    tmp_name_str.append(vec_BHEs[i]->get_name());
                    nod_val_name_vector.push_back(tmp_name_str.c_str());
                    nod_val_name_vector.push_back(tmp_name_str.c_str());
                    tmp_name_str = std::string(pcs_primary_function_name[5]);
                    tmp_name_str.append("_");
                    tmp_name_str.append(vec_BHEs[i]->get_name());
                    nod_val_name_vector.push_back(tmp_name_str.c_str());
                    nod_val_name_vector.push_back(tmp_name_str.c_str());
                    tmp_name_str = std::string(pcs_primary_function_name[6]);
                    tmp_name_str.append("_");
                    tmp_name_str.append(vec_BHEs[i]->get_name());
                    nod_val_name_vector.push_back(tmp_name_str.c_str());
                    nod_val_name_vector.push_back(tmp_name_str.c_str());
                ...
                case BHE::BHE_TYPE_2U: // 2U type has 8 unknowns
                    ...
                    nod_val_name_vector.push_back(tmp_name_str.c_str());
                    nod_val_name_vector.push_back(tmp_name_str.c_str());
                    tmp_name_str = std::string(pcs_primary_function_name[2]);
                    tmp_name_str.append("_");
                    tmp_name_str.append(vec_BHEs[i]->get_name());
                    nod_val_name_vector.push_back(tmp_name_str.c_str());
                    nod_val_name_vector.push_back(tmp_name_str.c_str());
                    ...
                    nod_val_name_vector.push_back(tmp_name_str.c_str());
                    nod_val_name_vector.push_back(tmp_name_str.c_str());
                    tmp_name_str = std::string(pcs_primary_function_name[4]);
                    tmp_name_str.append("_");
                    tmp_name_str.append(vec_BHEs[i]->get_name());
                    nod_val_name_vector.push_back(tmp_name_str.c_str());
                    nod_val_name_vector.push_back(tmp_name_str.c_str());
                    ...
                    nod_val_name_vector.push_back(tmp_name_str.c_str());
                    nod_val_name_vector.push_back(tmp_name_str.c_str());
                    tmp_name_str = std::string(pcs_primary_function_name[7]);
                    tmp_name_str.append("_");
                    tmp_name_str.append(vec_BHEs[i]->get_name());
                    nod_val_name_vector.push_back(tmp_name_str.c_str());
                    nod_val_name_vector.push_back(tmp_name_str.c_str());
                    tmp_name_str = std::string(pcs_primary_function_name[8]);
                    tmp_name_str.append("_");
                    tmp_name_str.append(vec_BHEs[i]->get_name());
                    nod_val_name_vector.push_back(tmp_name_str.c_str());
                    nod_val_name_vector.push_back(tmp_name_str.c_str());
        ...
        if (mmp_vector[i]->is_BHE)
        {
            ...
            case BHE::BHE_TYPE_CXA:
				...
				m_bhe_cxa = new BHE::BHE_CXA(mmp_vector[i]->geo_name, mmp_vector[i]->bhe_bound_type, mmp_vector[i]->bhe_use_ext_therm_resis, mmp_vector[i]->bhe_user_defined_therm_resis, mmp_vector[i]->bhe_length, mmp_vector[i]->bhe_diameter, mmp_vector[i]->bhe_refrigerant_flow_rate,
											 ...
											 mmp_vector[i]->bhe_pipe_out_wall_thickness, mmp_vector[i]->bhe_refrigerant_viscosity, mmp_vector[i]->bhe_refrigerant_density, mmp_vector[i]->bhe_refrigerant_alpha_L,
											 mmp_vector[i]->bhe_refrigerant_heat_capacity, mmp_vector[i]->bhe_grout_density, mmp_vector[i]->bhe_grout_porosity, mmp_vector[i]->bhe_grout_heat_capacity,
                                             mmp_vector[i]->bhe_regrigerant_heat_conductivity, mmp_vector[i]->bhe_therm_conductivity_inner_pipe_wall, mmp_vector[i]->bhe_therm_conductivity_outer_pipe_wall, mmp_vector[i]->bhe_therm_conductivity_grout,
                                             mmp_vector[i]->bhe_power_in_watt_val, mmp_vector[i]->bhe_power_in_watt_curve_idx, mmp_vector[i]->bhe_delta_T_val, mmp_vector[i]->bhe_intern_resistance, mmp_vector[i]->bhe_therm_resistance,
											 mmp_vector[i]->bhe_R_fig, mmp_vector[i]->bhe_R_fog, mmp_vector[i]->bhe_R_gg1, mmp_vector[i]->bhe_R_gg2, mmp_vector[i]->bhe_R_gs, mmp_vector[i]->bhe_heating_cop_curve_idx, mmp_vector[i]->bhe_cooling_cop_curve_idx, mmp_vector[i]->bhe_use_flowrate_curve, mmp_vector[i]->bhe_flowrate_curve_idx,
											 mmp_vector[i]->bhe_switch_off_threshold);
...
void CRFProcess::ConfigDeformation()
{
	...
	else if(type == 42)
	{
		...
		Shift[problem_dimension_dm +
		      1] = Shift[problem_dimension_dm] + m_msh->GetNodesNumber(false);
				...
				for(ii = 0; ii < dof; ii++)
				{
					for(jj = 0; jj < dof; jj++)
					{
						...
						if(type == 4)
							...
							a_ij =
							        (*m_dom->eqs->A)(i + no_dom_nodes *
							                         ii,j +
							                         no_dom_nodes * jj);
						(*eqs_new->A)(ig + Shift[ii],jg +
						              Shift[jj]) += a_ij;
#else // ifdef  NEW_EQS
						SetLinearSolver(m_dom->eqs);
						a_ij = MXGet(i + no_dom_nodes * ii,
						             j + no_dom_nodes * jj);
		...
		for(i = 0; i < no_dom_nodes; i++)
		{
			...
			for(j0 = 0; j0 < ncol; j0++)
			{
				...
				for(ii = 0; ii < dof; ii++) //ww
				{
					...
					// dom to global. WW
					a_ij =
					        (*m_dom->eqsH->A)(i + no_dom_nodesHQ * dof,j +
					                          no_dom_nodesHQ * ii);
					a_ji =
					        (*m_dom->eqsH->A)(j + no_dom_nodesHQ * ii, i +
					                          no_dom_nodesHQ * dof);
					(*eqs_new->A)(ig + Shift[ii],jg +
					              Shift[problem_dimension_dm]) += a_ij;
					(*eqs_new->A)(jg + Shift[problem_dimension_dm],ig +
					              Shift[ii]) += a_ji;
		...
		for(i = 0; i < no_dom_nodes; i++)
		{
			...
			for(j0 = 0; j0 < ncol; j0++)
			{
				...
				a_ij =
				        (*m_dom->eqsH->A)(i + no_dom_nodesHQ * dof,j +
				                          no_dom_nodesHQ * dof);
				(*eqs_new->A)(ig + Shift[problem_dimension_dm],jg +
				              Shift[problem_dimension_dm])
				        += a_ij;
#else
				SetLinearSolver(m_dom->eqs);
				...
				// set global system matrix
				SetLinearSolver(eqs);
				MXInc(ig + Shift[problem_dimension_dm],jg +
				      Shift[problem_dimension_dm],a_ij);
#endif
			}
			//
 ...
 **************************************************************************/
	void CRFProcess::AssembleSystemMatrixNew(void)
	{
	  ...
	  case 14:
		...
		default:
			DisplayMsgLn(
			        "CalculateElementMatrices: no CalculateElementMatrices specified");
			abort();
		}
#ifdef PARALLEL
		DDCAssembleGlobalMatrix();
         ...
         //................................................................
				...
				if(m_bc_node->conditional)
				{
					...
					for(ii = 0; ii < dof; ii++) //28.2.2007 WW
						...
						if (convertPrimaryVariableToString(m_bc->
						                                   getProcessPrimaryVariable())
						    .find(
						            pcs_primary_function_name[ii]) !=
						    string::npos)
						{
							idx_1 = GetNodeValueIndex(
							        pcs_primary_function_name[ii]) + 1;
							break;
						}
					bc_value = time_fac * fac * GetNodeValue(
		...
		for(i = begin; i < end; i++)
		{
			...
			if(axis == 0 && m_bc_node->pcs_pv_name.find("VELOCITY1_X") != string::npos)
			{
				...
				if(rank > -1)
				{
					bc_msh_node = bc_local_index_in_dom[i];
					int dim_space = 0;
					if(m_msh->NodesNumber_Linear ==
					   m_msh->NodesNumber_Quadratic)
						dim_space = 0;
					else
					{
				...
				if(bc_msh_node >= 0)
				{
					   ...
					   || type == 4 || type == 41  ) //Solution is in the manner of increment !
					{
						idx0 = GetNodeValueIndex(
						        convertPrimaryVariableToString(m_bc->
						                                       getProcessPrimaryVariable()));
						if(type == 4 || type == 41)
						{
							//30.08.2010. WW
							...
							bc_value = bc_value - GetNodeValue(
							        m_bc_node->geo_node_number,
							        idx0);
					}
					//----------------------------------------------------------------
			...
			// PCH
			else if(axis == 1 && m_bc_node->pcs_pv_name.find("VELOCITY1_Y") !=
			        string::npos)
			{
				m_bc = bc_node[gindex];
				shift = m_bc_node->msh_node_number - m_bc_node->geo_node_number;
			...
			// PCH
			else if(axis == 2 && m_bc_node->pcs_pv_name.find("VELOCITY1_Z") !=
			        string::npos)
			{
				m_bc = bc_node[gindex];
				shift = m_bc_node->msh_node_number - m_bc_node->geo_node_number;
	...
	char* GetCompNamehelp(char* inname)
	{
		...
		for(comp = 0; comp < GetRFProcessNumComponents(); comp++)
		{
			...
			if(strstr(inname, help) && (strcmp(inname,help) == 0))
			{
				...
				outname =
				        (char*) cp_vec[m_pcs->GetProcessComponentNumber() -
				                       1]->compname.data();
				return outname;
			}
		}
		...
		if(pcs_vector_size > 0)
			for(i = 0; i < pcs_vector_size; i++)
			{
				...
				if(m_pcs->getProcessType() == FiniteElement::MASS_TRANSPORT)
				{
					...
					outname =
					        cp_vec[m_pcs->GetProcessComponentNumber()]->
					        compname;
...
**************************************************************************/
	                                  ...
	                                  double vorgabe)
	{
		...
		if (name)
		{
			nval_data[anz_nval - 1].name = (char*) Malloc(((int)strlen(
			                                                       name) +
			                                               1) * sizeof(char));
		...
		if (einheit)
		{
			nval_data[anz_nval - 1].einheit = (char*) Malloc(((int)strlen(
			                                                          einheit) +
			                                                  1) * sizeof(char));
...
**************************************************************************/
	                                     ...
	                                     double vorgabe)
	{
		...
		if (name)
		{
			eval_data[anz_eval - 1].name = (char*) Malloc(((int)strlen(
			                                                       name) +
			                                               1) * sizeof(char));
		...
		if (einheit)
		{
			eval_data[anz_eval - 1].einheit = (char*) Malloc(((int)strlen(
			                                                          einheit) +
			                                                  1) * sizeof(char));
	...
	void CRFProcess::SetIC()
	{
        ...
        else if (this->getProcessType() == FiniteElement::HEAT_TRANSPORT_BHE)
        {
            for (size_t j = 0; j < ic_vector.size(); j++)
            {
                ...
                name = FiniteElement::convertPrimaryVariableToString(m_ic->getProcessPrimaryVariable());

                if (name.compare("TEMPERATURE_SOIL") == 0) // this is soil temperature
                    nidx = GetNodeValueIndex(name);
                else
                {
                    name_tmp.clear();
                    name_tmp << name << "_" << m_ic->getGeoName();
                    name = name_tmp.str();
                    nidx = GetNodeValueIndex(name);
                }
		...
		for (i = 0; i < no_richards_problems; i++)
		{
			...
			if (AverageZ_GW >= AverageZ_OLF)
			{
				...
				for (j = 0; j < NoOfGWNodes; j++)
				{
					NodeIndex_GW = m_ele_GW->GetNodeIndex(j);
					NodeIndex_OLF = m_ele_OLF->GetNodeIndex(j);
					AverageH_GW += m_pcs_GW->GetNodeValue(NodeIndex_GW,
					                                      idxHead_GW);
...
**************************************************************************/
	CRFProcess* PCSGet(const std::string &pcs_type_name, const std::string &comp_name)
	{
		...
		for (size_t i = 0; i < no_processes; i++)
			...
			if (pcs_vector[i]->getProcessType () == pcs_type)
				if (comp_name.compare (pcs_vector[i]->pcs_primary_function_name[0])
				    == 0)
					return pcs_vector[i];
...
/**************************************************************************
   ...
   last modification:
 *************************************************************************/
	double CRFProcess::GetCapillaryPressureOnNodeByNeighobringElementPatches(int nodeIdx,
	                                                                         int meanOption,
	                                                                         double Sw)
	{
	...
	void CRFProcess::CalcSaturationRichards(int timelevel, bool update)
	{
		...
		for (size_t i_pv = i_s; i_pv < i_e; i_pv++)
		{
			...
			for (long i = 0; i < (long) m_msh->GetNodesNumber(false); i++)
			{
				...
				{
					elem =
					        m_msh->ele_vector[m_msh->nod_vector[i]->
	...
	for (size_t i = 0; i < ele_vector_at_geo.size(); i++) {
		...
		for (size_t j = 0; j < static_cast<size_t> (m_ele->GetEdgesNumber()); j++) {
			...
			for (size_t k = 0; k < vecConsideredEdges.size(); k++)
				if (m_edg->GetIndex() == vecConsideredEdges[k]) Edge_already_used = true;
...
//	double totalmassflux; // 2012-08 TF / unused
	...
	//determine the dimension and the orientation of the mesh
	coordinateflag = m_msh->GetCoordinateFlag();
	if(coordinateflag == 10) {dimension = 1; axis = 0;}					       // x only
	else if(coordinateflag == 11) {dimension = 1; axis = 1;}                    // y only
	else if(coordinateflag == 12) {dimension = 1; axis = 2;}                    // z only
	else if(coordinateflag == 21) {dimension = 2; axis = 1;}                    // x, y only
	else if(coordinateflag == 22) {dimension = 2; axis = 2;}                    // x, z only
	else if(coordinateflag == 32) {dimension = 3;  axis = 3;}                   // x, y, z only
		...
		if (m_ele->GetDimension() == 2)
		{
			...
			for (size_t j = 0; j < static_cast<size_t>(m_ele->GetEdgesNumber()); j++)
			{
				...
				if ((m_edg->GetMark()) && (Use_Element == true) && (Edge_on_Geo == true))
				{
					...
					if (norm_v != 0)
					{
						Disp_xx = alpha_l * pow(v[0],2) / norm_v + alpha_t * pow(v[1],2) / norm_v;							//ToDo: z-Dimension
						...
						j_disp[0] = porosity * (Disp_xx * ConcentrationGradient[0] + Disp_xy * ConcentrationGradient[1]);  // [mol/m2.s]
						j_disp[1] = porosity * (Disp_yy * ConcentrationGradient[1] + Disp_xy * ConcentrationGradient[0]);  // [mol/m2.s]
						j_disp[2] = 0;																						// [mol/m2.s]
					}
					else
						for (size_t j = 0; j < 3; j++)
...
void CRFProcess::Calc2DElementGradient(MeshLib::CElem* m_ele, double ElementConcentration[4], double *grad)
{
	...
	{
		if (m_ele->GetElementType() == MshElemType::QUAD)		//BG 04/2011: calculation of the normal vector of a quad element
		  {
			//define the points used for the plane equation
			// order of points: 1, 2, 3, 4 against clock direction -> points are given in the order 1, 2, 4 to get a positive normal vector
...
{
	if(component_number < DOF_NUMBER_MAX){ // don't exceed array dimensions
...
**************************************************************************/
	bool CRFProcess::ELERelations()
	{
		...
		{
			cout << "->Write Matrix" << '\n';
			string m_file_name = FileName + "_" + convertProcessTypeToString (
			        this->getProcessType())
			                     + "_element_matrix.txt";
...
**************************************************************************/
	...
	bool CRFProcess::CreateEQS()
	{
		...
		else
		{
			 ...
			 */
			eqs =
			        CreateLinearSolver(m_num->ls_storage_method,
			                           m_msh->GetNodesNumber(false));
			InitializeLinearSolver(eqs,m_num);
			PCS_Solver.push_back(eqs);
			//}
				...
				for(i = 0; i < (long)m_msh->face_vector.size(); i++)
				{
					...
					for(m = col_min; m <= col_max; m++)
					{
						...
						for(n = row_min; n <= row_max; n++)
						{
							...
							if(nn < 0)
								nn = 0;
							cent[1] = g_para[3] + g_para[4] *
							          (nrow - nn + 0.5);

							if(cent[0] < x_min)
							{
								double const* const pnt (
								        elem->nodes[node_xmin]->
								        getData());
								cent[0] = pnt[0];
								cent[1] = pnt[1];
							}
...
//Modification:
//-------------------------------------------------------------------------
	void CRFProcess::CO2_H2O_NaCl_VLE_isobaric(double T,
	                                           double P,
	...
	void CRFProcess::CalculateFluidDensitiesAndViscositiesAtNodes(CRFProcess* m_pcs)
	{
		...
		for (long i = 0; i < (long)m_msh->nod_vector.size(); i++)
		{
			...
			for (size_t j = 0; j < m_node->getConnectedElementIDs().size(); j++)
			{
				...
				porosity = MediaProp->Porosity(
				        m_ele->GetIndex(), m_pcs->m_num->ls_theta);
			...
			else
			{
				...
				//+1... new time level
				variable_index = HeatProcess->GetNodeValueIndex("TEMPERATURE1") +
				                 TimeStepVariableIndex;
			...
			// +1: new timelevel
			variable_index =
			        pcs_vector[indexProcess]->GetNodeValueIndex(
			                pcs_vector[indexProcess]->pcs_primary_function_name[0]) +
			        TimeStepVariableIndex;
			//[mol/m³]
			...
			if (saturation_liquid > 0)
			{
				...
				for(int j = 0; j < iter_max; j++)
				{
					...
					wNaCl = c_NaClinLiquid / temp_density * Molweight_NaCl /
					        1000;
					...
					b_NaClinPureWater = c_NaClinLiquid / temp_density * 1 /
					                    wH2O;
			...
			if (saturation_gas > 0)
			{
				...
				variable_index = pcs_vector[indexProcess]->GetNodeValueIndex(
				        pcs_vector[indexProcess]->pcs_primary_function_name[0]) +
				                 TimeStepVariableIndex;
				//[mol/m³]
				c_H2OinGas = pcs_vector[indexProcess]->GetNodeValue(i,
				                                                    variable_index);
...
//-------------------------------------------------------------------------
	void CRFProcess::Phase_Transition_CO2(CRFProcess* m_pcs, int Step)
	{
		...
		double saturation_gas_min, saturation_liquid_min, saturation_gas_effective,
		       saturation_liquid_effective;
		...
		for (long i = 0; i < (long)m_msh->nod_vector.size(); i++)
		{
			...
			// unit: bar!!! Assuming that the non wetting phase pressure is the correct one
			gas.pressure = liquid.pressure = solid.pressure = m_pcs->GetNodeValue(
			                                         i,
			                                         variable_index)
			                                                  / 1e5;
			//+1... new time level
			...
			if (Step == 1)
			{
				...
				//[mol/m³]
				c_H2OinLiquid = pcs_vector[indexProcess]->GetNodeValue(
				        i,
				        variable_index);
				//[mol] = mol/m³ * m³
				...
				//[mol]
				liquid.H2O =
				        (Density_liquid * liquid.volume - liquid.CO2 *
				         Molweight_CO2 *
				         1e-3 - liquid.NaCl * Molweight_NaCl *
				         1e-3 ) / (Molweight_H2O * 1e-3);
			...
			if (Step == 1)
			{
				...
				variable_index = pcs_vector[indexProcess]->GetNodeValueIndex(
				        pcs_vector[indexProcess]->pcs_primary_function_name[0]) + 1;
				//[mol/m³]
				c_CO2inGas = pcs_vector[indexProcess]->GetNodeValue(i,
				                                                    variable_index);
				...
				// [mol] = kg / (kg / mol)
				gas.CO2 =
				        (Density_gas * gas.volume - gas.H2O * Molweight_H2O *
				         1e-3) / (Molweight_CO2 * 1e-3);
